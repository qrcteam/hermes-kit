...
> <One sentence, in her words, from the SOUL interview. Not yet captured — ask on install day.>
...
| Model | <ChatGPT Plus / Claude Pro>, **her** account |
| Digest | `<cron>` UTC = <local time> |
...
$1,500 founder-cohort price, offered in writing 2026-08-12 (see `docs/08-the-offer.md`).
Install #4 of 5. Deliverables include her GoHighLevel connected and readable, and one stuck
project finished.

## Prep sent

Accounts page: <https://beautiful-possibilities.com/kit/install/start> — the six accounts to
create before install day. Sent ahead of the 2026-08-21 meeting.
